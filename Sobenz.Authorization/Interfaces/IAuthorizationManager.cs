...
namespace Sobenz.Authorization.Interfaces
{
    public interface IAuthorizationManager
    {
        ...
        Task<ITokenResponse> GenerateUserAccessTokenAsync(Application application, string authroizationCode, string codeVerifier, Uri redirectUri, IEnumerable<string> scopes, int? organisationId, out HttpStatusCode statusCode, CancellationToken cancellationToken);
